     ...
     //   }
        ...
        lv_subCata.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
                print("Load "+subCataList.get(position).getType());
                Intent cookeryListPage = new Intent(getApplicationContext(), CoockeryListPage.class);
                cookeryListPage.putExtra("type",subCataList.get(position).getType());
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                switch (id) {
                    ...
                    case R.id.Shareapp:
                        ...
                        intentShare.putExtra(Intent.EXTRA_TEXT, "I suggest this app for you : https://play.google.com/store/apps/details?id=com.jaapps.cookegg");
...
/*
        ...
        public void run() {
            ...
            if(json != null) {
                ...
                try {
                    ...
                    if (success == 1) {
                        dishSubTypeArray = json.getJSONArray("dishtypes");
                        ...
                        print("JKS added "+subCataList.size());
    ...
    public boolean checksubTypePresent(List<ListCatagory> list, int type)
    {
